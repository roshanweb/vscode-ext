...
- How to contribute a test generator chat participant to the GitHub Copilot Chat view. (`@atrtestgenerator`, [simple.ts](src/simple.ts))
- How to use specialized commands for different types of test generation (/api, /web)
...
- Run the `Run Extension` target in the Debug View. This will:
	...
	- You will see the @atrtestgenerator chat participant show in the GitHub Copilot Chat view

## About this sample

This sample shows different ways to build a chat participant in VS Code:

See [simple.ts](src/simple.ts) for an example of a test generator chat participant that makes requests and responds to user queries. It shows how you can create specialized test generators for different scenarios (API tests vs Web UI tests).

See [testGenerator.tsx](src/testGenerator.tsx) for examples of prompt templates for different types of test generation. This demonstrates how you can use the [@vscode/prompt-tsx](https://www.npmjs.com/package/@vscode/prompt-tsx) library to create structured prompts for different use cases.
